...
module.exports.run = async (bot, message, args) => {
    if (!message.member.permissions.has(`MANAGE_CHANNELS`)) return message.channel.send({ content: `This \`${args[0]}\` command requires "Manage Channels" permission, which I don't have :c`});
